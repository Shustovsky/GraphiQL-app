...
export function Docs({ apiUrl }: DocsProps) {
  ...
  return (
    <div className="customScrollbar cursor-default absolute top-[7%] right-[50px] max-w-[80%] max-h-[80vh] bg-[#002B36] border-black border-8 p-3 rounded-md flex flex-row overflow-scroll gap-2 z-50">
